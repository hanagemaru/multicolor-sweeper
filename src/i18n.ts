...
const COPY = {
  ja: {
    ...
    deleteOnlineData: "オンラインデータを削除",
    deleteOnlineDataQuestion: "オンラインデータを削除しますか？",
    deleteOnlineDataWarning: "名前とランキング記録を削除します。この操作は取り消せません。",
    delete: "削除",
    deleting: "削除中…",
    dataDeleted: "削除しました",
  ...
  en: {
    ...
    deleteOnlineData: "DELETE ONLINE DATA",
    deleteOnlineDataQuestion: "DELETE ONLINE DATA?",
    deleteOnlineDataWarning: "This deletes your name and ranking records. This action cannot be undone.",
    delete: "DELETE",
    deleting: "DELETING...",
