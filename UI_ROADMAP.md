...
- 高い予兆音と短い静けさから、フラッシュ・28粒子・低い衝撃音・全セルの吹き飛びへつなぐCINEMATIC BLAST
- 通常CLEARは現行の左上→右下ウェーブ、自己ベスト更新時は中心波・光条・16スパーク・大きな終止和音のSUPER CLEAR
- 1〜4マスは開封数と同数発音、5マス以上は最大6連打＋終止和音へ約250ms以内で圧縮する開封音
...
EFFECT LAB:
- 採用: 開封は斜めスキャン、爆発はCINEMATIC BLAST、通常CLEARはCLEAR WAVE、自己ベスト更新時はSUPER CLEAR
- 未採用候補を削除せず、光5種・爆発3種・CLEAR 3種を `?effects-lab=1` で引き続き個別・連続・ランダム比較できる
